...
public class PageHandler {
	...
	public static void main(String[] args) {
		...
		PageHandler handler = new PageHandler(6, 33, 4, 5);
		
		
		System.out.println( handler.getTotalPage() );  // 9
		System.out.println( handler.getCurrentGrp() ); // 2
		System.out.println( handler.getGrpStartPage() ); // 6
		System.out.println(handler.getGrpEndPage() ); // 9
